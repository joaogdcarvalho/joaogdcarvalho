...
Possuo experiência com projetos Back-end (.Net Framework, .Net Core, ASP.net MVC, Microsoft SQL Server) e Front-end (HTML5, CSS3, JavaScript) e atualmente estou ~~quebrando a cabeça~~ aprendendo e criando soluções com TypeScript, React.js, React Native e Node.js
...
Já concluí cursos oferecidos pela @RocketSeat, @Caelum e School of Art, Game e Animation.
